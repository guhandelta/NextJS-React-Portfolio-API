const data = {
    portfolios: [
        ...
        },
        {
            ...
            location: 'Huntington, West Virginia',
            jobTitle: 'Web Developer',
            description: '•	Designed a secure responsive web interface using Bootstrap4 for viewing the website easily on any device. <br/> •	Architecting a fast, robust back - end using Python Django to record the posts and intimate the personnel about any new maintenance requests and the pre - registered maintenance dates <br/> •	Django ORM was used here to manage all the equipment and user information, over SQL lite 3 DB <br/> •	Utilized the Django templates to design robust user interface for the web application <br/> ',
            userId: 'google-oauth2|101848771434318992569',
        ...
        },
        {
            ...
            description: '•	Actively involved in Requirement Gathering meetings with the Clients and Participated in project planning sessions with business analysts and team members to analyze business IT Requirements and translated business requirements into working model. br /> •	Implemented Single Page Application(SPA) using HTML5, CSS3, Bootstrap and Angular 4. br /> •	Participated in code review meetings and provided improvements. br /> •	Use SVN for software configuration management and version control and deploy the application in JBOSS server. br /> •	Developed custom JSON parsers to automatically discover the projects or schemas defined in the data source. br /> •	Developed internal web dashboard applications using Node JS. br /> •	Analyzed and fixed bugs reported in QTP and effectively delivered bug fixes reported with  quick turnaround time br /> ',
            userId: 'google-oauth2|101848771434318992569',
